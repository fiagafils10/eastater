...
const PropertyDetails = ({ propertyDetails}) => (
 ...
 <Box maxWidth='1000px' margin='auto' p='4'>
    ...
    <Box>
      {propertyDetails?.amenities.length && <Text fontSize='2xl' fontWeight='black' marginTop='5'>Facilites:</Text>}
        <Flex flexWrap='wrap'>
...
export async function getServerSideProps({ params: { id } }) {
  const data = await fetchBayutApi(`/properties/detail?externalID=${id}`);
